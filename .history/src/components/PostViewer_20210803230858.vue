<template>
    ...
    <div class="q-gutter-sm">
      ...
      <q-btn color="primary" size="sm" text-color="white" label="More info" @click="edit(post.id)" flat/>
      <q-btn color="red" size="sm" text-color="white" label="Delete post" @click="deletePost(post.id)"/>
      </q-timeline-entry>
      </div>
</template>
