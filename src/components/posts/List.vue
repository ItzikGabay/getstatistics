/*************************** * * file: * /components/posts/List.vue * * Summary:
* Show posts as a component. * * Description: * Whenever client ask to see
posts, we use this component * * Father Components: * views/posts/Posts.vue *
***************************/
